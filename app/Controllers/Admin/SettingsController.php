...
class SettingsController {
	...
	public function init() {
		...
		add_filter( 'plugin_action_links_' . RT_SB_API_PLUGIN_ACTIVE_FILE_NAME, [ $this, 'marketing' ] );
	...
	public function pro_alert_html() {
		...
		$html .= '<div class="rt-document-box rt-alert rt-pro-alert">
					...
					<div class="rt-box-content">
						<h3 class="rt-box-title">' . esc_html__( 'Pro field alert!', 'api-for-shopbuilder' ) . '</h3>
						<p><span></span>' . esc_html__( 'Sorry! this is a Pro field. To use this field, you need to use Pro plugin.', 'api-for-shopbuilder' ) . '</p>
						<a href="' . esc_url( rtTpg()->proLink() ) . '" target="_blank" class="rt-admin-btn">' . esc_html__( 'Upgrade to Pro', 'api-for-shopbuilder' ) . '</a>
	...
	public function register() {
		add_submenu_page(
			...
			esc_html__( 'Settings', 'api-for-shopbuilder' ),
			esc_html__( 'Settings', 'api-for-shopbuilder' ),
			'administrator',
			'tpg_api_settings',
			[ $this, 'settings' ]
		...
		add_submenu_page(
			'edit.php?post_type=' . rtTPGApi()->post_type_layout,
			esc_html__( 'Get Help', 'api-for-shopbuilder' ),
			esc_html__( 'Get Help', 'api-for-shopbuilder' ),
			'administrator',
			'tpg_api_get_help',
			[ $this, 'get_help' ]
