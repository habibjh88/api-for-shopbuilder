...
class TaxonomyMeta {
	...
	public function edit_term_columns( $columns ) {
		...
		$columns[ rtTPGApi()->rttpg_cat_thumbnail ] = esc_html__( 'Image', 'api-for-shopbuilder' );
		$columns[ rtTPGApi()->rttpg_cat_status ]    = esc_html__( 'Status', 'api-for-shopbuilder' );
	...
	*/
	public function add_category_image( $taxonomy ) { ?>
        <div class="form-field term-group">
            <label for="<?php echo esc_attr( rtTPGApi()->rttpg_cat_thumbnail ) ?>"><?php _e( 'Image', 'api-for-shopbuilder' ); ?></label>
            ...
            <p>
                <input type="button" class="button button-secondary rttpg_media_button" id="rttpg_media_button" name="rttpg_media_button" value="<?php _e( 'Add Image', 'api-for-shopbuilder' ); ?>"/>
                <input type="button" class="button button-secondary rttpg_media_remove" id="rttpg_media_remove" name="rttpg_media_remove" value="<?php _e( 'Remove Image', 'api-for-shopbuilder' ); ?>"/>
            </p>
        </div>

        <div class="form-field term-group">
            <label for="<?php echo esc_attr( rtTPGApi()->rttpg_cat_status ) ?>"><?php _e( 'Status', 'api-for-shopbuilder' ); ?></label>
	...
	*/
	public function update_category_image( $term, $taxonomy ) { ?>
        ...
        <tr class="form-field term-group-wrap">
            <th scope="row">
                <label for="<?php echo esc_attr( rtTPGApi()->rttpg_cat_status ) ?>"><?php _e( 'Image', 'api-for-shopbuilder' ); ?></label>
            </th>
            <td>
